    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 align-self-center">
        ...
        <?php if( get_theme_mod( 'online_pharmacy_email_address' ) != '') { ?>
          <span class="ms-3"><a href="mailto:<?php echo esc_html( get_theme_mod('online_pharmacy_email_address','') ); ?>"><i class="<?php echo esc_attr(get_theme_mod('online_pharmacy_mail_icon','far fa-envelope')); ?> me-2"></i><?php echo esc_html( get_theme_mod('online_pharmacy_email_address','')); ?></a></span>
        <?php } ?>
      </div>
        ...
        <div class="media-links text-md-end">
          ...
          <?php if( get_theme_mod( 'online_pharmacy_facebook_url' ) != '' || get_theme_mod( 'online_pharmacy_twitter_url' ) != '' || get_theme_mod( 'online_pharmacy_instagram_url' ) != '' || get_theme_mod( 'online_pharmacy_youtube_url' ) != '' || get_theme_mod( 'online_pharmacy_pint_url' ) != '') { ?>
            ...
            <?php if( get_theme_mod( 'online_pharmacy_pint_url' ) != '') { ?>
              <a <?php if($online_pharmacy_header_pint_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'online_pharmacy_pint_url','' ) ); ?>"><i class="<?php echo esc_attr(get_theme_mod('online_pharmacy_printerest_icon','fab fa-pinterest')); ?> me-3"></i></a>
            <?php } ?>
          <?php } ?>
        </div>
      </div>
