...
jQuery(document).ready(function(){
    ...
    jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-menu').attr("checked","checked");

    jQuery('#expert-healthcare-setup-menu').click(function(){
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-menu').css("display","block");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-contact').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-widget').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-social-icon').css("display","none");
    });

    jQuery('#expert-healthcare-setup-contact').click(function(){
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-menu').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-contact').css("display","block");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-widget').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-social-icon').css("display","none");
    });

    jQuery('#expert-healthcare-setup-widget').click(function(){
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-menu').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-contact').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-widget').css("display","block");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-social-icon').css("display","none");
    });

    jQuery('#expert-healthcare-setup-social').click(function(){
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-menu').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-contact').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-widget').css("display","none");
        jQuery('#expert-healthcare-demo-setup-guid .expert-healthcare-setup-social-icon').css("display","block");
    });
});