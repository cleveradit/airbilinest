...
$expert_healthcare_post_tags = get_theme_mod('expert_healthcare_post_tags_settings','1');
...
$expert_healthcare_single_post_tags = get_theme_mod('expert_healthcare_single_post_tags_settings','1');
...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
	...
	<?php
        if ( is_singular() ) :
    		if ($expert_healthcare_single_post_tags == '1') : ?>
			    <div class="blog-tags mt-3">
					<?php  the_tags(); ?>
				</div>
	        <?php endif; 
        else :
        	 if ($expert_healthcare_post_tags == '1') : ?>
		    	<div class="blog-tags mt-3">
					<?php  the_tags(); ?>
				</div>
			<?php endif; ?>
