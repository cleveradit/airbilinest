...
<section class="blog-area inarea-blog-single-page-two">
	<div class="container">
		<div class="row">
            <?php 
                $expert_healthcare_single_post_sidebar_setting = get_theme_mod('expert_healthcare_single_post_sidebar_setting','1');
                $expert_healthcare_sidebar_position = get_theme_mod('expert_healthcare_sidebar_position', 'right');
                $expert_healthcare_content_class = ($expert_healthcare_single_post_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $expert_healthcare_single_post_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
