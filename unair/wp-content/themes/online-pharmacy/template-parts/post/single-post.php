    ...
    <div class="box-info">
        ...
        foreach ($online_pharmacy_blog_archive_ordering as $online_pharmacy_blog_data_order) : 
            ...
            <?php elseif ('comment' === $online_pharmacy_blog_data_order) : ?>
                <i class="fas fa-comments mb-1 me-2"></i><span class="entry-comments me-3"><?php comments_number(__('0 Comments', 'online-pharmacy'), __('0 Comments', 'online-pharmacy'), __('% Comments', 'online-pharmacy')); ?></span>
            <?php elseif ('category' === $online_pharmacy_blog_data_order) :?>
                <i class="fas fa-list mb-1 me-2"></i><span class="entry-category me-3"><?php online_pharmacy_display_post_category_count(); ?></span>
            <?php endif;
        endforeach; ?>
    </div>
    <hr>
