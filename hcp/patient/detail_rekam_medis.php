...
$sql = "SELECT m.*, p.nama_pasien, u.username as nama_dokter FROM medical_records AS m JOIN patients AS p ON p.id = m.patient_id JOIN users AS u ON u.id = m.user_id WHERE m.id='$medical_record_id'";
...
<body>
    ...
    <div class="info">
        ...
        <h1>Detail <?php echo $lang['medical_record']; ?> : <?php echo $patient['nama_pasien'] ?></h1>
            ...
            <form method="POST" action="save_rekam_medis.php">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <input value="<?php echo $medical_record['tempat_rawat'] ?>" type="text" name="tempat_rawat" class="form-control" id="tempat_rawat" required>
                    </div>
                    <!-- Tanggal -->
                    <div class="form-group col-lg-3 col-md-4 col-sm-6 col-12">
                        <label for="tanggal_ambil_data">Tanggal</label>
                        <input value="<?php echo $medical_record['tanggal_ambil_data'] ?>" type="date" name="tanggal_ambil_data" class="form-control" id="tanggal_ambil_data" required>
                    </div>
                    <!-- Waktu -->
                    <div class="form-group col-lg-3 col-md-4 col-sm-6 col-12">
                        <label for="waktu_ambil_data">Waktu</label>
                        <input value="<?php echo $medical_record['waktu_ambil_data'] ?>" type="time" name="waktu_ambil_data" class="form-control" id="waktu_ambil_data" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 bg-info text-light">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['berat_aktual']?>" type="text" name="berat_aktual" class="form-control" id="berat_aktual" required>
                    </div>

                    <!-- HR -->
                    <div class="form-group col-md-3">
                        <label for="hr">HR (bpm)</label>
                        <input value="<?php echo $medical_record['hr']?>" type="text" name="hr" class="form-control" id="hr" required>
                    </div>

                    <!-- RR -->
                    <div class="form-group col-md-3">
                        <label for="rr">RR (bpm)</label>
                        <input value="<?php echo $medical_record['rr']?>" type="text" name="rr" class="form-control" id="rr" required>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" name="eritema" id="eritema" required>
                            <option value=""></option>
                            <option <?php echo $medical_record['eritema']=='Iya' ? 'selected' : ''?> value="Iya">Iya</option>
                            <option <?php echo $medical_record['eritema']=='Tidak' ? 'selected' : ''?> value="Tidak">Tidak</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['suhu_aksila']?>" type="text" name="suhu_aksila" class="form-control" id="suhu_aksila" required>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['kewaspadaan']?>" type="text" name="kewaspadaan" class="form-control" id="kewaspadaan" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['hemoglobin']?>" type="text" name="hemoglobin" class="form-control" id="hemoglobin" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="hematokrit">Hematokrit (Hct)</label>
                        <input value="<?php echo $medical_record['hematokrit']?>" type="text" name="hematokrit" class="form-control" id="hematokrit" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="jumlah_sel_darah_merah">Jumlah Sel Darah Merah (RBC)</label>
                        <input value="<?php echo $medical_record['jumlah_sel_darah_merah']?>" type="text" name="jumlah_sel_darah_merah" class="form-control" id="jumlah_sel_darah_merah" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="jumlah_sel_darah_putih">Jumlah Sel Darah Putih (WBC)</label>
                        <input value="<?php echo $medical_record['jumlah_sel_darah_putih']?>" type="text" name="jumlah_sel_darah_putih" class="form-control" id="jumlah_sel_darah_putih" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="jumlah_trombosit">Jumlah Trombosit (10³/μL)</label>
                        <input value="<?php echo $medical_record['jumlah_trombosit']?>" type="text" name="jumlah_trombosit" class="form-control" id="jumlah_trombosit" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="hasil_darah">Hasil Darah</label>
                        <input value="<?php echo $medical_record['hasil_darah']?>" type="text" name="hasil_darah" class="form-control" id="hasil_darah" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['sgot']?>" type="number" name="sgot" class="form-control" id="sgot" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="sgpt">SGPT (U/L)</label>
                        <input value="<?php echo $medical_record['sgpt']?>" type="number" name="sgpt" class="form-control" id="sgpt" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="hasil_fungsi_hati">Hasil Fungsi Hati</label>
                        <input value="<?php echo $medical_record['hasil_fungsi_hati']?>" type="text" name="hasil_fungsi_hati" class="form-control" id="hasil_fungsi_hati" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="hasil_bilinorm">Hasil Bilinorm</label>
                        <input value="<?php echo $medical_record['hasil_bilinorm']?>" type="text" name="hasil_bilinorm" class="form-control" id="hasil_bilinorm" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['alat_fototerapi']?>" type="text" name="alat_fototerapi" class="form-control" id="alat_fototerapi" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="lama_fototerapi">Lama (jam)</label>
                        <input value="<?php echo $medical_record['lama_fototerapi']?>" type="number" name="lama_fototerapi" class="form-control" id="lama_fototerapi" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="waktu_mulai_fototerapi">Waktu mulai</label>
                        <input value="<?php echo $medical_record['waktu_mulai_fototerapi']?>" type="time" name="waktu_mulai_fototerapi" class="form-control" id="waktu_mulai_fototerapi" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="waktu_lepas_fototerapi">Waktu Lepas</label>
                        <input value="<?php echo $medical_record['waktu_lepas_fototerapi']?>" type="time" name="waktu_lepas_fototerapi" class="form-control" id="waktu_lepas_fototerapi" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="intensitas_fototerapi">Intensitas</label>
                        <input value="<?php echo $medical_record['intensitas_fototerapi']?>" type="number" name="intensitas_fototerapi" class="form-control" id="intensitas_fototerapi" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input value="<?php echo $medical_record['tcb_sebelum_fototerapi']?>" type="number" name="tcb_sebelum_fototerapi" class="form-control" id="tcb_sebelum_fototerapi" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="tsb_sebelum_fototerapi">TSB Sebelum Fototerapi (mg/dL)</label>
                        <input value="<?php echo $medical_record['tsb_sebelum_fototerapi']?>" type="number" name="tsb_sebelum_fototerapi" class="form-control" id="tsb_sebelum_fototerapi" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="tcb_sesudah_fototerapi">TCB Sesudah Fototerapi (mg/dL)</label>
                        <input value="<?php echo $medical_record['tcb_sesudah_fototerapi']?>" type="number" name="tcb_sesudah_fototerapi" class="form-control" id="tcb_sesudah_fototerapi" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="tsb_sesudah_fototerapi">TSB Sesudah Fototerapi (mg/dL)</label>
                        <input value="<?php echo $medical_record['tsb_sesudah_fototerapi']?>" type="number" name="tsb_sesudah_fototerapi" class="form-control" id="tsb_sesudah_fototerapi" required>
                    </div>
                </div>
