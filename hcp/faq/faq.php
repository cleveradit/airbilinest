...
<html lang="<?php echo $language; ?>">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../assetsICONMKA.ico" />
        ...
        <div class="faq-container">
            ...
            <div class="faq-section">
                ...
                <div class="faq-item" data-category="airbilinest">
                    ...
                    <button class="faq-question">5. <?php echo $lang['faq_question5']; ?></button>
                ...
                <div class="faq-item" data-category="airbilinest">
                    ...
                    <button class="faq-question">6. <?php echo $lang['faq_question6']; ?></button>
                ...
                <div class="faq-item" data-category="medikakaryaairlangga">
                    ...
                    <button class="faq-question">7. <?php echo $lang['faq_question7']; ?></button>
