...
<div class="container-scroller">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            <div class="wrapper d-flex align-items-center">
                                <h4 class="card-title">Add Pasien</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="tcb_sebelum_fototerapi" class="form-control" id="tcb_sebelum_fototerapi" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="tsb_sebelum_fototerapi">TSB Sebelum Fototerapi (mg/dL)</label>
                                            <input type="text" name="tsb_sebelum_fototerapi" class="form-control" id="tsb_sebelum_fototerapi" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="tcb_sesudah_fototerapi">TCB Sesudah Fototerapi (mg/dL)</label>
                                            <input type="text" name="tcb_sesudah_fototerapi" class="form-control" id="tcb_sesudah_fototerapi" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="tsb_sesudah_fototerapi">TSB Sesudah Fototerapi (mg/dL)</label>
                                            <input type="text" name="tsb_sesudah_fototerapi" class="form-control" id="tsb_sesudah_fototerapi" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        <button class="btn btn-md btn-gradient-success" type="submit">Simpan Pasien</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql_worklist = "INSERT INTO worklist (
            ...
            alat_fototerapi,
            lama_fototerapi,
            waktu_mulai_fototerapi,
            waktu_lepas_fototerapi,
            intensitas_fototerapi,
            tcb_sebelum_fototerapi,
            tsb_sebelum_fototerapi,
            tcb_sesudah_fototerapi,
            tsb_sesudah_fototerapi,
            observasi,
            catatan
        ) VALUES (
            '$user_id',
