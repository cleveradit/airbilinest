                                                ...
                                                <tbody>
                                                    <?php foreach ($medical_records as $index => $medical_record) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="medical_record_print.php?id=<?php echo $medical_record['id'] ?>" target="_blank" class="btn btn-xs btn-outline btn-outline-primary me-1" title="Print">
                                                                    <i class="fa fa-print"></i>
                                                                </a>
                                                                <a href="medical_record_edit.php?id=<?php echo $medical_record['id'] ?>" class="btn btn-xs btn-outline btn-outline-info me-1" title="Edit">
                                                                    <i class="fa fa-pencil-square-o"></i>
                                                                </a>
                                                                <a href="#" class="btn btn-xs btn-outline btn-outline-danger me-1 btn-delete"
                                                                    title="Delete" data-id="<?= $medical_record['id'] ?>">
        ...
        $(document).on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = `medical_record_delete.php?id=${medicalRecordId}`;
