        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Medical Record : <?php echo $patient['nama_pasien'] ?></h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url() ?>hcp/dashboard/patient/medical_record?id=<?php echo $patient['id'] ?>">Medical Record</a></li>
